...
public class AffichageEmissionActivity extends AppCompatActivity implements Adaptermovie.OnItemSelectedListener {
    ...
    private void fetchMovie(Call<PageMovies> call, GridLayoutManager layoutManager){
        ...
        call.clone().enqueue(new Callback<PageMovies>() {
            ...
            public void onResponse(Call<PageMovies> call, Response<PageMovies> response) {
                ...
                adaptermovie=new Adaptermovie(AffichageEmissionActivity.this,moviesList,AffichageEmissionActivity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.logout:
                if(checkConnection.isConnected(AffichageEmissionActivity.this)) {
                    editor.clear();
                    editor.commit();
                    Intent intentlog = new Intent(AffichageEmissionActivity.this, Authentification.class);
    ...
    public void itemClick(int position) {
        ...
        Intent intenttodetails=new Intent(AffichageEmissionActivity.this,AffichageDetailsActivity.class);
